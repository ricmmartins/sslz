...
if [[ "$TOOL" == "terraform" ]]; then
  ...
  echo "budgets) are not removed by deleting resource groups. To remove them:"
  echo ""
  ...
  echo "  az monitor diagnostic-settings subscription delete --name diag-activity-log-to-law --yes"
  echo ""
  echo "  # Budget"
